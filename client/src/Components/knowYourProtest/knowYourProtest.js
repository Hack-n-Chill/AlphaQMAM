        ...
        <ul class="collapsible popout">
          <li>
            <div class="collapsible-header" style={{ fontWeight: "bold" }}>
              <i class="material-icons">pan_tool</i>Your rights
            </div>
            <div style={{ fontSize: "20px" }} class="collapsible-body">
              <span>
                <ul>
                  <li>
                    {" "}
          ...
          <li>
            <div class="collapsible-header" style={{ fontWeight: "bold" }}>
              <i class="material-icons">videocam_off</i>What to do if you are stopped
          ...
          <li>
            <div class="collapsible-header" style={{ fontWeight: "bold" }}>
              <i class="material-icons">gavel</i>What happens if the police
          ...
          <li>
            <div class="collapsible-header" style={{ fontWeight: "bold" }}>
              <i class="material-icons">local_police</i>If you are stopped by the Police
            </div>
            <div style={{ fontSize: "20px" }} class="collapsible-body">
              <span>
                <ul>
          ...
          <li>
            <div class="collapsible-header" style={{ fontWeight: "bold" }}>
              <i class="material-icons">assignment</i>Do I need a permit?
            </div>
            <div style={{ fontSize: "20px" }} class="collapsible-body">
              <span>
                <ul>
                  ...
                  <li>
                    4. If the permit regulations that apply to your protest
          ...
          <li>
            <div class="collapsible-header" style={{ fontWeight: "bold" }}>
              <i class="material-icons">sentiment_very_dissatisfied</i>What to do if you believe your
            ...
            <div style={{ fontSize: "20px" }} class="collapsible-body">
              <span>
                <ul>
                  ...
                  <li>2. Get contact information for witnesses.</li>
                  <li>3. Take photographs of any injuries.</li>
                  <li>
